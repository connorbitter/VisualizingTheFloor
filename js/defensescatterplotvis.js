/*
 * DefenseScatterPlotVis - Object constructor function
 * @param _parentElement  -- the HTML element in which to draw the visualization
 * @param _data           -- the actual data
 */

DefenseScatterPlotVis = function(_parentElement, _data){
...
DefenseScatterPlotVis.prototype.initVis = function(){
  var vis = this;
  ...
  vis.statDropdown = d3.select("#defense-stat-dropdown");
  ...
  $("#defense-stat-dropdown").change(function() {
    vis.wrangleData();
  });
...
DefenseScatterPlotVis.prototype.wrangleData = function(){
  var vis = this;
...
DefenseScatterPlotVis.prototype.updateVis = function(){
  var vis = this;
  ...
  vis.xAxis.scale(vis.x)
    .tickFormat(function(d){
      if (vis.selectedStat == "Opp. FG%" || vis.selectedStat == "Opp. 3P%" || vis.selectedStat == "Opp. FT%" || vis.selectedStat == "Opp. AFG%") {
  ...
  vis.tip
    .html(function(d) {
      ...
      var selectedStatRank = 1 + (vis.ranks[vis.selectedStat].findIndex(function(e) {
        return e.TEAM == d.TEAM;
      }))
  ...
  function findRankReverse(team, stat){
    var rank = 1 + (vis.ranks[stat].findIndex(function(e) {
        return e.TEAM == team;
    }))
  ...
  function showTable(d){
    $("#defense-table-team").html(d.TEAM);
    $("#defense-table-record").html(d['Wins'] + ' - ' + (82 - d['Wins']));
    $("#defense-table-record-rank").html(findRank(d.TEAM, 'Wins'));

    $("#defense-table-selected-stat").html(vis.selectedStat);
    $("#defense-table-stat").html(d[vis.selectedStat]);
    $("#defense-table-stat-rank").html(findRankReverse(d.TEAM, vis.selectedStat));
    ...
    $("#defense-gsw-record").html(vis.displayData[goldenStateIndex]['Wins'] + ' - ' + (82 - vis.displayData[goldenStateIndex]['Wins']));
    $("#defense-gsw-record-rank").html(findRank('Golden State Warriors', 'Wins'));
