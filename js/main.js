...
function createVis(error, perDayData, metaData){
	...
	var ageVis = new AgeVis("agevis", perDayData);
	var prioVis = new PrioVis("priovis", perDayData, metaData);

	// (5) Bind event handler
	
	$(BrushHandler).bind("selectionChanged", function(event, rangeStart, rangeEnd){
